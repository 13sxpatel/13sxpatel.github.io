...
var fragmentShaderHeaderNumLines = fragmentShaderHeader.split('\n').length;
...
function gl_start(canvas, vertexShader) {           // START WEBGL RUNNING IN A CANVAS
   ...
   setTimeout(function() {
	 ...
	 if (shaderError.length == 0)
	    ...
	    errorLineNumber = parseInt(message) - fragmentShaderHeaderNumLines;
...
function accentColor(isTrue) { return isTrue ? '#000000' : '#000000'; }
